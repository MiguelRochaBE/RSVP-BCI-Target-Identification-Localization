...
public:
    ...
    void         RenderCubeMapFromPosition(Texture* cubeColor, Texture* cubeDepth, int cubeMapSize, Vector3f translation);
    void         RenderCubemap();
    ...
    void HmdColorDescChange(OptionVar* = 0);
...
protected:
    ...
    bool                DrawControllerLinearVelocity;
    bool                DrawControllerAngularVelocity;
    bool                DrawControllerLinearAccel;
    bool                DrawControllerAngularAccel;
    ...
    int                 LayerCubemapRenderResolution;
